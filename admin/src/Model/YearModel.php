...
/**
 * Jtax Year Admin Model
 *
 * @since  1.6
 */
class YearModel extends AdminModel
{
	...
	protected array $styles = [
		...
		'administrator/components/com_jtax/assets/css/year.css'
 	];
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_jtax.year';
	 ...
	 * @throws  \Exception
	 */
	public function getTable($type = 'year', $prefix = 'Administrator', $config = [])
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_jtax.edit.year.data', []);
