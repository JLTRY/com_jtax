...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->canDo = JtaxHelper::getActions('import');
        ...
        if($this->hasPackage && $this->dataType)
        {
            ...
            $this->headers         = JtaxHelper::getFileHeaders($this->dataType);
            // clear the data type
    ...
    {
        ToolbarHelper::title(Text::_('COM_JTAX_IMPORT_TITLE'), 'upload');
        ...
        $this->help_url = JtaxHelper::getHelpUrl('import');
