...
/**
 * Jtax component helper.
 *
 * @since   3.0
 */
abstract class JtaxHelper
{
	/**
	 * Composer Switch
	 *
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_jtax/jtax.xml";
    ...
    */
	 ...
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'jtax')
	{
	 ...
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'jtax', $unique = true)
	{
	...
	public static function getModel(string $type, string $prefix = 'Administrator',
		string $component = 'jtax', array $config = [])
	{
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_jtax');

		$parentId = $parent->id;
		$name     = 'com_jtax.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_jtax', $table, $inherit);
			...
			else
			{
				...
				return Factory::getDbo()->updateObject('#__jtax_'.$table, $object, 'id');
			}
		}
		return false;
	}
