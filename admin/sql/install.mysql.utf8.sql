...
CREATE TABLE IF NOT EXISTS `#__jtax_impot` (
	...
	`nbparts` FLOAT(64) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `#__jtax_year` (
	...
	`asset_id` INT(10) unsigned NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
	`name` VARCHAR(255) NULL DEFAULT '',
	`taux1` FLOAT(64) NOT NULL DEFAULT 0,
	`taux2` FLOAT(64) NOT NULL DEFAULT 0,
	`taux3` FLOAT(64) NOT NULL DEFAULT 0,
	`taux4` FLOAT(64) NOT NULL DEFAULT 0,
