...
/** @var \JLTRY\Component\Jtax\Administrator\View\Year\HtmlView $this */

$icon = 'icon-check';
$title_key = $this->item->id ?? '';
$title_column = $this->item->name ?? '';
$data = [
    'contentType' => 'com_jtax.year',
    'id' => $title_key,
    'title' => $title_column,
    'uri' => Route::_('index.php?option=com_jtax&layout=modal&tmpl=component&id='. (int) ($this->item->id ?? 0))
];
