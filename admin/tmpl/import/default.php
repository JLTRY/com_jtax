...
Joomla.continueImport = function() {
    ...
    // do field validation
    if (error) {
        alert("<?php echo Text::_('COM_JTAX_IMPORT_MSG_PLEASE_SELECT_ALL_COLUMNS', true); ?>");
    } else {
...
Joomla.submitbutton = function() {
    ...
    if (form.import_package.value == "") {
        alert("<?php echo Text::_('COM_JTAX_IMPORT_MSG_PLEASE_SELECT_A_FILE', true); ?>");
    } else {
        document.getElementById('loading').style.display = 'block';
...
Joomla.submitbutton3 = function() {
    ...
    if (form.import_directory.value == ""){
        alert("<?php echo Text::_('COM_JTAX_IMPORT_MSG_PLEASE_SELECT_A_DIRECTORY', true); ?>");
    } else {
        document.getElementById('loading').style.display = 'block';
...
Joomla.submitbutton4 = function() {
    ...
    if (form.import_url.value == "" || form.import_url.value == "http://") {
        alert("<?php echo Text::_('COM_JTAX_IMPORT_MSG_ENTER_A_URL', true); ?>");
    } else {
        document.getElementById('loading').style.display = 'block';
...
<form enctype="multipart/form-data" action="<?php echo Route::_('index.php?option=com_jtax&view=import');?>" method="post" name="adminForm" id="adminForm" class="form-horizontal form-validate">
    <div id="main-card">

    <?php if ($this->hasPackage && ArrayHelper::check($this->headerList) && ArrayHelper::check($this->headers)) : ?>
        <fieldset class="uploadform">
            <legend><?php echo Text::_('COM_JTAX_IMPORT_LINK_FILE_TO_TABLE_COLUMNS'); ?></legend>
            <div class="control-group">
                <label class="control-label" ><h4><?php echo Text::_('COM_JTAX_IMPORT_TABLE_COLUMNS'); ?></h4></label>
                <div class="controls">
                    <label class="control-label" ><h4><?php echo Text::_('COM_JTAX_IMPORT_FILE_COLUMNS'); ?></h4></label>
                </div>
            </div>
            ...
            <div class="form-actions">
                <input class="btn btn-primary" type="button" value="<?php echo Text::_('COM_JTAX_IMPORT_CONTINUE'); ?>" onclick="Joomla.continueImport()" />
            </div>
        </fieldset>
    ...
    <?php else: ?>
        ...
        <?php echo Html::_('uitab.addTab', 'myTab', 'upload', Text::_('COM_JTAX_IMPORT_FROM_UPLOAD', true)); ?>
            <fieldset class="uploadform">
                <legend><?php echo Text::_('COM_JTAX_IMPORT_UPDATE_DATA'); ?></legend>
                <div class="control-group">
                    <label for="import_package" class="control-label"><?php echo Text::_('COM_JTAX_IMPORT_SELECT_FILE'); ?></label>
                    <div class="controls">
                        <input class="input_box" id="import_package" name="import_package" type="file" size="57" />
                    </div>
                </div>
                <div class="form-actions">
                    <input class="btn btn-primary" type="button" value="<?php echo Text::_('COM_JTAX_IMPORT_UPLOAD_BOTTON'); ?>" onclick="Joomla.submitbutton()" />&nbsp;&nbsp;&nbsp;<small><?php echo Text::_('COM_JTAX_IMPORT_FORMATS_ACCEPTED'); ?> (.csv .xls .ods)</small>
                </div>
            </fieldset>
        <?php echo Html::_('uitab.endTab'); ?>

        <?php echo Html::_('uitab.addTab', 'myTab', 'directory', Text::_('COM_JTAX_IMPORT_FROM_DIRECTORY', true)); ?>
            <fieldset class="uploadform">
                <legend><?php echo Text::_('COM_JTAX_IMPORT_UPDATE_DATA'); ?></legend>
                <div class="control-group">
                    <label for="import_directory" class="control-label"><?php echo Text::_('COM_JTAX_IMPORT_SELECT_FILE_DIRECTORY'); ?></label>
                    <div class="controls">
                ...
                <div class="form-actions">
                    <input type="button" class="btn btn-primary" value="<?php echo Text::_('COM_JTAX_IMPORT_GET_BOTTON'); ?>" onclick="Joomla.submitbutton3()" />&nbsp;&nbsp;&nbsp;<small><?php echo Text::_('COM_JTAX_IMPORT_FORMATS_ACCEPTED'); ?> (.csv .xls .ods)</small>
                </div>
                </fieldset>
        <?php echo Html::_('uitab.endTab'); ?>

        <?php echo Html::_('uitab.addTab', 'myTab', 'url', Text::_('COM_JTAX_IMPORT_FROM_URL', true)); ?>
            <fieldset class="uploadform">
                <legend><?php echo Text::_('COM_JTAX_IMPORT_UPDATE_DATA'); ?></legend>
                <div class="control-group">
                    <label for="import_url" class="control-label"><?php echo Text::_('COM_JTAX_IMPORT_SELECT_FILE_URL'); ?></label>
                    <div class="controls">
                        <input type="text" id="import_url" name="import_url" class="span5 input_box" size="70" value="http://" />
                    </div>
                </div>
                <div class="form-actions">
                    <input type="button" class="btn btn-primary" value="<?php echo Text::_('COM_JTAX_IMPORT_GET_BOTTON'); ?>" onclick="Joomla.submitbutton4()" />&nbsp;&nbsp;&nbsp;<small><?php echo Text::_('COM_JTAX_IMPORT_FORMATS_ACCEPTED'); ?> (.csv .xls .ods)</small>
                </div>
            </fieldset>
        <?php echo Html::_('uitab.endTab'); ?>
