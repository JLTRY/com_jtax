...
if ($this->saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_jtax&task=years.saveOrderAjax&tmpl=component';
    Html::_('sortablelist.sortable', 'yearList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
