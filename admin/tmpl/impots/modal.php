...
/** @var \JLTRY\Component\Jtax\Administrator\View\Impots\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_jtax&view=impots&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
