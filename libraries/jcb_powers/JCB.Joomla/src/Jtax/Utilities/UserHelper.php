...
/***[JCBGUI.power.licensing_template.52.$$$$]***/
/**
...
namespace JCB\Joomla\Jtax\Utilities;



/***[JCBGUI.power.head.52.$$$$]***/
...
use JCB\Joomla\Utilities\Component\Helper as Component;
use JCB\Joomla\Utilities\ArrayHelper;
use JCB\Joomla\Utilities\StringHelper;
use JCB\Joomla\Jtax\Utilities\Exception\NoUserIdFoundException;
...
/***[JCBGUI.power.main_class_code.52.$$$$]***/
    /**
        ...
        array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
    {
        ...
        {
            throw new \InvalidArgumentException(Text::_('COM_JTAX_CAN_NOT_SAVE_USER_WITHOUT_EMAIL_VALUE'));
        }
        ...
        array $params = ['useractivation' => 0, 'sendpassword' => 1], int $mode = 1): int
    {
        ...
        if ($mode === 2 && method_exists(ComponentbuilderHelper::class, 'registerUser'))
        {
            ...
            throw new NoUserIdFoundException(Text::_('COM_JTAX_USER_CREATION_FAILED'));
        }
        ...
        throw new NoUserIdFoundException(
            Text::sprintf('COM_JTAX_USER_S_S_CREATION_FAILEDS',
    ...
    public static function update(array $userDetails): int
    {
        ...
        throw new \RuntimeException(
            Text::sprintf('COM_JTAX_UPDATE_OF_USER_S_S_FAILEDS',
