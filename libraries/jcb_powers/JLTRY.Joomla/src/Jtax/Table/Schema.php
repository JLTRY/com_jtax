...
namespace JLTRY\Joomla\Jtax\Table;


use JLTRY\Joomla\Jtax\Table;
use JLTRY\Joomla\Interfaces\SchemaInterface;
use JLTRY\Joomla\Abstraction\Schema as ExtendingSchema;
